...
const LandingPageHero = () => {
    return (
        <div>
            <div className="flex flex-col md:flex-row items-center md:items-start justify-around gap-8 xl:gap-16 [@media(min-width:1058px)]:gap-20">
                <div className='space-y-5 md:w-1/2 md:my-5'>
                    ...
                    <div className='my-10 space-y-5'>
                        <div className="flex items-center space-x-4 bg-[#0A66C2] w-[85%] mx-auto md:w-auto justify-center rounded-3xl">
                            <img src={google} alt="google" className='bg-gray-50 p-2 rounded-full h-10 w-10' />
                            <h1 className='text-white'>Continue with Google</h1>
                        </div>

                        <div className="flex items-center space-x-4 border py-2 w-[85%] mx-auto md:w-auto justify-center rounded-3xl">
